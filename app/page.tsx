      ...
      <section className="py-24 bg-gradient-to-br from-[#F6B100] via-[#585c25] to-[#F6B100] text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Link 
              href="/contact"
              className="bg-white text-[#F6B100] hover:bg-gray-100 px-10 py-5 rounded-full font-bold inline-flex items-center justify-center gap-2 transition-all text-lg shadow-xl"
            >
              Partner With Us <ArrowRight size={24} />
            </Link>
            <Link 
